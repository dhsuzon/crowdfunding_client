                ...
                {reported.map(c => (
                  <tr key={c._id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 flex space-x-2">
                      <Button onPress={() => handleSuspend(c._id)} className="px-3 py-1 bg-yellow-100 text-yellow-700 rounded hover:bg-yellow-200 text-xs">Suspend</Button>
                      <Button onPress={() => handleDelete(c._id)} className="px-3 py-1 bg-red-100 text-red-700 rounded hover:bg-red-200 text-xs">Delete</Button>
                    </td>
                  </tr>
                ))}
