              ...
              {withdrawals.map(w => (
                <tr key={w._id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4">
                    <button onClick={() => handleApprove(w._id)} className="px-3 py-1 bg-green-100 text-green-700 rounded hover:bg-green-200 text-xs font-medium">Payment Success</button>
                  </td>
                </tr>
              ))}
